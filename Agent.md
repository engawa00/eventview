...
- Windows wake reason types ('0', '1', '8') in `event_viewer.py` should be mapped to human-readable descriptions using an `if-elif` construct, rather than introducing a module-level dictionary.
